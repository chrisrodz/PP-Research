...
_sage_const_31 = Integer(31); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_6 = Integer(6)
count = _sage_const_0  # cuente los PP

l = set() # Guarda los PP evaluados para verificar que no se repitan los resultados

p = _sage_const_31  # Tamano del  cuerpo
...
for a in range(_sage_const_1 , p): # Fija a
        for b in range(_sage_const_1 , p): # Fija b
                ...
                f = (x**(((p-_sage_const_1 )/_sage_const_2 )+_sage_const_1 )) + (a * x**(((p-_sage_const_1 )/_sage_const_6 )+_sage_const_1 )) + (b * x) # El polinomio
