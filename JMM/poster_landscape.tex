...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    Let $\alpha$ be a primitive root of $\mathbb{F}_{q}$ we define a relation to construct equivalence classes of polynomials with value sets of the same cardinality.
...
\includegraphics[width=11cm, height=5.5cm]{clases}
...
Starting from one polynomial we can construct lcm($d_1, d_2$) other polynomials.
...
\headerbox{Ongoing Work}{name=future,column=2,below=work}{
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \item Collect data on the number of permutation polynomials of this form for different values of $d_1$ and $d_2$ and compare results with the number of binomial permutation polynomials.
  \end{itemize}
}\label{Applications}
