...
\begin{frame}{Finite Fields}
  ...
  \begin{example}
    ...
    \textbf{Addition:}\linebreak
    $2+2$ over $\mathbb{F}_7 = 4$ but $4+4$ over $\mathbb{F}_7 = 8$ mod $7 = 1$
    \textbf{Multiplication:}\linebreak
    $2\times2$ over $\mathbb{F}_7 = 4 $ but $ 4\times4$ over $\mathbb{F}_7 = 16$ mod $7 = 2$
  \end{example}
\end{frame}
