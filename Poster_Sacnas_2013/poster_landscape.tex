...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   ...
   The preliminaries is based on \cite{awf:tracking}. Our main contributions are
   \begin{enumerate}\compresslist
   \item Efficient incorporation of a background appearance model
   \item Formulation as a shortest path abstract
...
\begin{minipage}{0.3\linewidth}
  \includegraphics[width=\linewidth]{logo_uprrp}\\[1em]
\end{minipage}&
\begin{minipage}{0.3\linewidth}
