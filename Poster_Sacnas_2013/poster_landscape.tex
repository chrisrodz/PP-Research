...
%  textfont=\sc, An example of changing the text font
  ...
  headershade=shadelr,
  headerfont=\huge\textsc, %Sans Serif
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   Permutation polynomias over finite fields are important in many applications, for example in cryptography. We want to provide rich families of polynomials that are permutation polynomials. In particular we study polynomials of the form $F_{a,b}(x) = x^{\frac{q+1}{2}} + a\cdot x^{\frac{q-1}{d}} + b\cdot x$ where $a,b \in \mathbb{F}_{q}$, $q=p^r$ $p$ prime and $d \mid q-1$.
   
   \vspace{0.3em}
 }\label{Abstract}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\headerbox{Problem}{name=problem,column=1,row=0,span=2}{
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
      
      {\Large We study the number of polynomials of the form $F_{a,b}(x) = x^{\frac{q+1}{2}} + a\cdot x^{\frac{q+1}{d}} + b\cdot x$ over finite fields that are permutation polynomials.}

      \vspace{0.3em}
}\label{Problem}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \headerbox{Value set of a class of polynomials}{name=contribution,column=1,span=2,below=problem}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \begin{multicols}{2}
...
\vspace{0.3em}
\begin{itemize}
\item Verify if our results work for polynomials of the form
  \begin{equation}\label{f_a_la_m}
    F_{a,b}(x) = x^{\frac{q+1}{2}+m} + a\cdot x^{\frac{q+1}{d}+m} + b\cdot x^{m}
  \end{equation}
  where $m \in \mathbb{F}_q$
\item Verify if there exist conditions for the pair $[a, b]$ such that~\ref{f_a_la_m} \& ~\ref{polinomio} are permutation polynomials.
\end{itemize}
   \vspace{0.3em}
  }\label{Future Work}
